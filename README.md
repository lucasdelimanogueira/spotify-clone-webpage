...
<html lang="pt-br">
  ...
  <body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark navbar-transparent">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <button type="button" class="navbar-toggler collapsed" data-toggle="collapse" 
                  data-target="#navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <h3>Descobrir</h3>  
            <p>Curva músicas novas toda segunda-feira com uma playlist personalizada pra você. Ou relaxe e curta uma das rádios.</p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <ul class="nav">
              ...
              <li class="nav-item"><a class="nav-link" href="">Empregos</a></li>
              <li class="nav-item"><a class="nav-link" href="">Imprensa</a></li>
          ...
          <div class="col-md-2">
            ...
            <ul class="nav">
              <li class="nav-item"><a class="nav-link" href="">Ajuda</a></li>
              <li class="nav-item"><a class="nav-link" href="">Presentes</a></li>
              <li class="nav-item"><a class="nav-link" href="">Player da web</a></li>
            </ul>
          </div>

          <div class="col-md-4">
            <ul class="nav">
              <li class="nav-item item-rede-social"><a class="nav-link" href=""><img src="img/facebook.png"></a></li>
              <li class="nav-item"><a class="nav-link" href=""><img src="img/twitter.png"></a></li>
              <li class="nav-item"><a class="nav-link" href=""><img src="img/instagram.png"></a></li>
            </ul>
          </div>
